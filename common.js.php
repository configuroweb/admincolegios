...
function students_validateData(){
	...
	/* Field FullName can't be empty */
	if($j('#FullName').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> FullName", close: function(){ $j('[name=FullName]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	...
	/* Date field DOB can't be empty */
	if($j('#DOB-dd').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Death Of Birth", close: function(){ $j('#DOB-dd').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#DOB-mm').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Death Of Birth", close: function(){ $j('#DOB-mm').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#DOB').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Death Of Birth", close: function(){ $j('#DOB').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	...
	/* Field Class can't be empty */
	if($j('#Class').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Class", close: function(){ $j('[name=Class]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Date field DOJ can't be empty */
	if($j('#DOJ-dd').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> DOJ", close: function(){ $j('#DOJ-dd').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#DOJ-mm').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> DOJ", close: function(){ $j('#DOJ-mm').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#DOJ').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> DOJ", close: function(){ $j('#DOJ').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field AcademicYear can't be empty */
	if($j('#AcademicYear').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> AcademicYear", close: function(){ $j('[name=AcademicYear]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field TotalFees can't be empty */
	if($j('#TotalFees').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> TotalFees", close: function(){ $j('[name=TotalFees]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field AdvanceFees can't be empty */
	if($j('#AdvanceFees').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> AdvanceFees", close: function(){ $j('[name=AdvanceFees]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function feescollection_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field Student can't be empty */
	if($j('#Student').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Student", close: function(){ $j('[name=Student]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Session can't be empty */
	if($j('#Session').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Session", close: function(){ $j('[name=Session]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field PaidAmount can't be empty */
	if($j('#PaidAmount').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> PaidAmount (Ksh)", close: function(){ $j('[name=PaidAmount]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Branch can't be empty */
	if($j('#Branch').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Branch", close: function(){ $j('[name=Branch]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function branch_validateData(){
	$j('.has-error').removeClass('has-error');
	...
	/* Field AccountNumber can't be empty */
	if($j('#AccountNumber').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> AccountNumber", close: function(){ $j('[name=AccountNumber]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function teachers_validateData(){
	...
	/* Field Gender can't be empty */
	if($j('#Gender').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Gender", close: function(){ $j('[name=Gender]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Age can't be empty */
	if($j('#Age').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Age", close: function(){ $j('[name=Age]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Phone can't be empty */
	if($j('#Phone').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Phone", close: function(){ $j('[name=Phone]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field StaffNumber can't be empty */
	if($j('#StaffNumber').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> StaffNumber", close: function(){ $j('[name=StaffNumber]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
...
function streams_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field Name can't be empty */
	if($j('#Name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=Name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function hostels_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field Name can't be empty */
	if($j('#Name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=Name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Status can't be empty */
	if($j('#Status').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Status", close: function(){ $j('[name=Status]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function timetable_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Image field Time_Table can't be empty */
	if($j('#Time_Table').val() == '' && !$j('#Time_Table-link:visible').length){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Time Table", close: function(){ $j('[name=Time_Table]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Class can't be empty */
	if($j('#Class').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Class", close: function(){ $j('[name=Class]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function events_validateData(){
	...
	/* Rich HTML area field Details can't be empty */
	var nicDetails = nicEditors.findEditor('Details').getContent();
	if(nicDetails == '' || nicDetails == '<br>' || nicDetails == '<br/>' || nicDetails == '<br>'){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Details", close: function(){ $j('[name=Details]').parents('.form-group').addClass('has-error'); } }); return false; }
	return true;
}
...
function examresults_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field student can't be empty */
	if($j('#student').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Student", close: function(){ $j('[name=student]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Marks can't be empty */
	if($j('#Marks').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Marks", close: function(){ $j('[name=Marks]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Term can't be empty */
	if($j('#Term').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Term", close: function(){ $j('[name=Term]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function parents_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field Name can't be empty */
	if($j('#Name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=Name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Phone can't be empty */
...
function examcategories_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field Name can't be empty */
	if($j('#Name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=Name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function sessions_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field Year can't be empty */
	if($j('#Year').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Year", close: function(){ $j('[name=Year]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Term can't be empty */
	if($j('#Term').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Term", close: function(){ $j('[name=Term]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function studentcategories_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field Name can't be empty */
	if($j('#Name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=Name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function classattendance_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field Subject can't be empty */
	if($j('#Subject').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Subject", close: function(){ $j('[name=Subject]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field Student can't be empty */
	if($j('#Student').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Student", close: function(){ $j('[name=Student]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function schoolmoney_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field Class can't be empty */
	if($j('#Class').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Class", close: function(){ $j('[name=Class]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Rich HTML area field Particulars can't be empty */
	var nicParticulars = nicEditors.findEditor('Particulars').getContent();
	if(nicParticulars == '' || nicParticulars == '<br>' || nicParticulars == '<br/>' || nicParticulars == '<br>'){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Particulars", close: function(){ $j('[name=Particulars]').parents('.form-group').addClass('has-error'); } }); return false; }
	/* Field Total can't be empty */
	if($j('#Total').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Total", close: function(){ $j('[name=Total]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
...
function persist_expanded_child(id){
	var expand_these = Cookies.getJSON('FANTASTIC_SCHOOL_ADMIN.dvp_expand');
	...
	if($j('[id=' + id + ']').hasClass('active')){
		if(expand_these.indexOf(id) < 0){
			...
			Cookies.set('FANTASTIC_SCHOOL_ADMIN.dvp_expand', expand_these, { expires: 30 });
		}
	}else{
		if(expand_these.indexOf(id) >= 0){
