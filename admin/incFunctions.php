<?php
	...
	*/
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				...
				'branch' => array(
					'Caption' => 'Branch',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/card_bank.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'teachers' => array(
				...
				'classes' => array(
					'Caption' => 'Classes',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/door_open.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'streams' => array(
				...
				'timetable' => array(
					'Caption' => 'TimeTable',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/data_chooser.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'events' => array(
					'Caption' => 'Events',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/date_add.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'notices' => array(
					'Caption' => ' Notices/Announcements',
					'Description' => '',
				...
				'examresults' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/application_view_columns.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'parents' => array(
				...
				'studentcategories' => array(
					'Caption' => 'StudentCategories',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/blackboard_steps.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'classattendance' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/chart_down_color.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'schoolmoney' => array(
	...
	function getThumbnailSpecs($tableName, $fieldName, $view){
		if($tableName=='students' && $fieldName=='Photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='students' && $fieldName=='Photo' && $view=='dv')
