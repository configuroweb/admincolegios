...
<?php
	...
	if(is_array($arrTables) && count($arrTables)){
		...
		foreach($tg as $tn => $tgroup){
			...
			$tChkAHAN = array_search($tn, array('students','feescollection','branch','teachers','subjects','classes','streams','hostels','timetable','events','notices','examresults','parents','examcategories','sessions','studentcategories','classattendance'));
